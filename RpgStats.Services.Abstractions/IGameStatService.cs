...
public interface IGameStatService
{
    ...
    Task<ServiceResult<GameStatDto>> CreateGameStatAsync(long gameId, long statId, int sortIndex);
    Task<ServiceResult<GameStatDto>> UpdateGameStatAsync(long gameStatId, long gameId, long statId, int sortIndex);
